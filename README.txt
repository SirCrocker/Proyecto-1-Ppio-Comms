...
correspondientemente en la carpeta 'saved_model\my_model'. La funcionalidad del NLP dentro del servidor es la de poder interpretar los mensajes del cliente en 
función de la opción que este desea seleccionar, es decir, en vez de seleccionar un ítem del menú por el dígito que lo identifica se puede pedir con palabras.
